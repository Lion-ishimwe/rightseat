        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-slate-600">Welcome back, {authUser.user.email.split('@')[0]}</p>
            </div>
          </div>
      ...
      <main className="p-6">
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 text-white">
            ...
            <p className="text-blue-100 text-lg">Manage all modules and oversee system operations</p>
          </div>

          {/* Module Access Grid */}
          <div>
            <h3 className="text-2xl font-bold text-slate-800 mb-6">Module Access</h3>
              ...
              {modules.map((module) => {
                ...
                return (
                  <div
                    ...
                    className="bg-white rounded-2xl shadow-sm border border-slate-200/50 p-6 hover:shadow-lg transition-all duration-200 cursor-pointer group"
                  >
                    ...
                    <h4 className="text-lg font-semibold text-slate-800 mb-2">{module.title}</h4>
